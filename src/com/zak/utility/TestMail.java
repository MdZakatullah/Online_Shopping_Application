...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "modern.alumni@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Modern Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Modern Electronics.<br>"
					...
					+ "<span class='greenText'>MODERN500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
